...
I've trained the model on about 1000 images and using Keras' data augmentation pipeline. Currently the model is 85% accurate on my dataset. Please feel free to add your own data to make the model more accurate. For model training code see `behind_the_scenes` folder.
